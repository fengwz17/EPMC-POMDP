...
public final class ProblemsPOMDP {
    ...
    public static final Problem DD_NOT_SUPPORTED = newProblem("pomdp-dd-not-supported");
    ...
    public static final Problem PRISM_POMDP_ONE_MODEL_FILE = newProblem("prism-pomdp-one-input-file");
