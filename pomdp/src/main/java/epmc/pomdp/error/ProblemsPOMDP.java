...
public final class ProblemsPOMDP {
    private final static String ERROR_POMDP = "ErrorPOMDP";
    ...
    public final static Problem POMDP_PARSER_GENERAL_ERROR = newProblem("pomdp-parser-general-error");
    public final static Problem POMDP_PARSER_INTERNAL_ERROR = newProblem("pomdp-parser-internal-error");
    public final static Problem POMDP_PARSER_UNEXPECTED_CHARACTER = newProblem("pomdp-parser-unexpected-character");
    public final static Problem POMDP_PARSER_NO_MODULE = newProblem("pomdp-parser-no-module");
    public final static Problem POMDP_PARSER_MULTIPLE_INIT = newProblem("pomdp-parser-multiple-init");
    public final static Problem POMDP_PARSER_MULTIPLE_TYPE = newProblem("pomdp-parser-multiple-type");
    public final static Problem POMDP_PARSER_MULTIPLE_SYSTEM = newProblem("pomdp-parser-multiple-system");
    public final static Problem POMDP_PARSER_REPEATED_FORMULA = newProblem("pomdp-parser-repeated-formula");
    public final static Problem POMDP_PARSER_REPEATED_LABEL = newProblem("pomdp-parser-repeated-label");
    public final static Problem POMDP_PARSER_REPEATED_CONSTANT = newProblem("pomdp-parser-repeated-constant");
    public final static Problem POMDP_PARSER_REPEATED_MODULE = newProblem("pomdp-parser-repeated-module");
    public final static Problem POMDP_PARSER_REPEATED_PLAYER = newProblem("pomdp-parser-repeated-player");
    public final static Problem POMDP_PARSER_REPEATED_VARIABLE = newProblem("pomdp-parser-repeated-variable");
    public final static Problem POMDP_PARSER_REPEATED_REWARD = newProblem("pomdp-parser-repeated-reward");
    public final static Problem POMDP_PARSER_REPEATED_UPDATE = newProblem("pomdp-parser-repeated-update");
    public final static Problem POMDP_PARSER_SYNTAX_ERROR = newProblem("pomdp-parser-syntax-error");
    public final static Problem POMDP_PARSER_UNSUPPORTED_MODEL_TYPE = newProblem("pomdp-parser-unsupported-model-type");
    ...
    public static final Problem POMDP_ONE_MODEL_FILE = newProblem("pomdp-one-input-file");

    private static Problem newProblem(String name) {
        assert name != null;
        return UtilError.newProblem(ERROR_POMDP, name);
    }

    private ProblemsPOMDP() {
    }
}
