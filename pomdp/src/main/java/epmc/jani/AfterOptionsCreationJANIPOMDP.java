...
public class AfterOptionsCreationJANIPOMDP implements AfterOptionsCreation {
    private final static String IDENTIFIER = "jani-pomdp";
    ...
    public void process(Options options) {
        ...
        explorerExtensions.put(ExplorerExtensionPOMDP.IDENTIFIER, ExplorerExtensionPOMDP.class);
    ...
    private void addSemantics(Options options) {
        ...
        modelSemanticTypes.put(ModelExtensionPOMDP.IDENTIFIER, ModelExtensionPOMDP.class);
